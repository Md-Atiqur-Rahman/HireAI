...
def multiple_resume_analysis():
    ...
    banner_style("Intelligent Resume Processing (Batch Mode) 📂")
    ...
    if st.session_state.analyze_triggered and not st.session_state.analysis_done:
        ...
        for idx, resume_file in enumerate(st.session_state.resume_files):
            ...
            summary_text, total_exp, total_score,technicalskills,score_obj,raw_rows,status_Rank = evaluate_resume(resume_text, st.session_state.jd_file)
